...
const App = () => {
  ...
  // Retrieve any todo list items stored in local storage and display them
  useEffect(() => {
  ...
  // Set new todo items in the local storage
  useEffect(() => {
    if(todos.length > 0) {
  ...
  // Toggles the checkbox for items in todo list
